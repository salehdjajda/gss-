                ...
                <div className="space-y-5">
                  ...
                  <details className="border border-slate-200 rounded-xl overflow-hidden">
                    ...
                    <div className="px-5 py-4 bg-slate-50 space-y-3 text-sm text-gray-700 leading-relaxed">
                      <p>تنظم منصة GSS تقديم الاستشارات التشغيلية للمنشآت من خلال شبكة مستشارين متخصصين ضمن إطار تنسيقي واضح يضمن جودة التوصيات واستفادة المنشآت منها.</p>
                      <p className="font-semibold text-gray-800">آلية تنفيذ التوصيات الاستشارية</p>
                      <p>في حال اعتماد توصية تشغيلية مقدمة من المستشار وتنفيذها عبر المنصة، يتم توثيقها ضمن إجراءات التشغيل المعتمدة للمنصة وفق نموذج العمل الخاص بها.</p>
                    </div>
                  </details>
