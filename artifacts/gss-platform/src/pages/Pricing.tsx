        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-slate-50 border border-slate-200 rounded-3xl p-8">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              {isAr
                ? "في حال تطلّب تنفيذ أي خدمة توفير مواد أو أجهزة أو قطع غيار، يتم الاتفاق على آلية التوريد والدفع مسبقاً مع المنشأة. يشمل ذلك:"
                : "If any service execution requires procuring materials, equipment, or spare parts, the procurement and payment process is agreed upon with the facility in advance. This includes:"}
            </p>
